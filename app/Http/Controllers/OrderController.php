...
class OrderController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $order->viewed = 1;
        $order->save();
        $commission=CommissionHistory::where('order_id', decrypt($id))->first();
        if ($commission !=null)
            return view('backend.sales.show', compact('order', 'delivery_boys','commission'));
    ...
    public function store(Request $request)
    {
        ...
        foreach ($seller_products as $seller_product) {
            ...
            foreach ($seller_product as $cartItem) {
                ...
                $currencies= Currency::select('code','exchange_rate')->get();
                ...
                $order_detail->rate =json_encode($currencies);
