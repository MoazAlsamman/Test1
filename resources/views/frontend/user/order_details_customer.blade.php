                ...
                <div class="col-lg-6">
                    <table class="table-borderless table">
                        ...
                        <tr>
                            ...
                            <td>{{ single_price1($order->orderDetails->sum('price') + $order->orderDetails->sum('tax'),$order->orderDetails[0]->rate) }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tbody>
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                <tr>
                                    ...
                                    <td>{{ single_price1($orderDetail->price,$order->orderDetails[0]->rate) }}</td>
                                    @if (addon_is_activated('refund_request'))
                                        @php
                    ...
                    <table class="table-borderless table">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span
                                        class="strong-600">{{ single_price1($order->orderDetails->sum('price'),$order->orderDetails[0]->rate) }}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span
                                        class="text-italic">{{ single_price1($order->orderDetails->sum('shipping_cost'),$order->orderDetails[0]->rate) }}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span
                                        class="text-italic">{{ single_price1($order->orderDetails->sum('tax'),$order->orderDetails[0]->rate) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Coupon') }}</td>
                                <td class="text-right">
                                    <span class="text-italic">{{ single_price1($order->coupon_discount,$order->orderDetails[0]->rate) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Total') }}</td>
                                <td class="text-right">
                                    <strong><span>{{ single_price1($order->grand_total,$order->orderDetails[0]->rate) }}</span></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
