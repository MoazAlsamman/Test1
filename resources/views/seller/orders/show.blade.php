                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{isset($commission->admin_commission)?single_price($commission->admin_commission) : " " }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="text-muted h5">
                                {{isset($commission->admin_commission)?single_price($order->grand_total-$commission->admin_commission) : single_price($order->grand_total) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
