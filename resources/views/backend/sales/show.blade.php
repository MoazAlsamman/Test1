                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    {{ single_price1($order->grand_total,$order->orderDetails[0]->rate) }}
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                <tr>
                                    ...
                                    <td class="text-center">
{{--                                        {{ single_price1($orderDetail->price / $orderDetail->quantity,$orderDetail->rate) }}--}}
                                        {{ single_price1($orderDetail->price / $orderDetail->quantity,$orderDetail->rate) }}
                                    </td>
                                    <td class="text-center">
                                        {{ single_price1($orderDetail->price,$orderDetail->rate) }}
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {{ single_price1($order->orderDetails->sum('price'),$orderDetail->rate) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                {{ single_price1($order->orderDetails->sum('tax'),$orderDetail->rate) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                {{ single_price1($order->orderDetails->sum('shipping_cost'),$orderDetail->rate) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                {{ single_price1($order->coupon_discount,$orderDetail->rate) }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <strong class="text-muted">{{ translate('System Commission') }} :</strong>
                            </td>
                            <td>
                                {{isset($commission->admin_commission)?single_price1($commission->admin_commission,$order->orderDetails[0]->rate) : " " }}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="text-muted h5">
                                {{isset($commission->admin_commission)?single_price1($order->grand_total-$commission->admin_commission,$order->orderDetails[0]->rate) : single_price1(($order->grand_total),$order->orderDetails[0]->rate) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
